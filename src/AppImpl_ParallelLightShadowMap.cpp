...
#ifdef  AppImpl_ParallelLightShadowMap
...
void BuildScene()
{
	...
	waterRenderer->EnableCastShadow(false);
	waterRenderer->EnableReceiveShadow(false);
	waterRenderer->SetEnable(false);
	//
...
#endif //  AppImpl_ParallelLightShadowMap
